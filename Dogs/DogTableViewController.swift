...
//        
//        guard let meal1 = Meal(name: "MealOne", photo: photo1, rating: 4) else {
//            fatalError("Unable to instantiate meal1")
//        }
//        
//        guard let meal2 = Meal(name: "MealTwo", photo: photo2, rating: 5) else {
//            fatalError("Unable to instantiate meal2")
//        }
//        
//        guard let meal3 = Meal(name: "MealThree", photo: photo3, rating: 3) else {
//            fatalError("Unable to instantiate meal2")
//        }
//        
